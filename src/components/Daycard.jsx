    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-800 to-cyan-600 py-12 px-6">
      ...
      <div className="bg-pink-400 rounded-2xl shadow-2xl p-6 text-center">
        ...
        <div className="bg-amber-50 rounded-2xl shadow-2xl p-6 text-center ">
          ...
          <div>
            <button onClick={()=>nav("/Day23")} className="bg-red-600 p-3 w-full rounded-2xl text-white font-bold mt-4">View Process</button>
          </div>
       ...
       <div className="bg-cyan-400 rounded-2xl shadow-2xl p-6 text-center">
          <div className="w-20 h-20 rounded-full bg-amber-200 flex items-center justify-center mx-auto">
            <span className="text-4xl">🚀</span>
          </div>
           <div>
              ...
              <h1>LazyLoading And Env Process</h1>
            </div>
            <div>
              <button onClick={()=>nav("/Day25")} className="bg-blue-600 p-3 w-full rounded-2xl mt-4 text-white font-bold">View Work</button>
            </div>
